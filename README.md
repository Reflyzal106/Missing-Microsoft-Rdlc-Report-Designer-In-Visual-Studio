# [SOLVED] Missing-Microsoft-Rdlc-Report-Designer-In-Visual-Studio
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/missing-microsoft-rdlc-report-designer-in-visual-studio)
>
...
The RDLC Report Designer is no longer included in Visual Studio 2015, but it can be installed as an extension from the Visual Studio Marketplace.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/missing-microsoft-rdlc-report-designer-in-visual-studio)**
